...
<div class="flex flex-col justify-center items-center project">
	...
	<section class="second-background">
		<div class="flex flex-col gap-2 max-w-xl w-full justify-center">
				...
				<div class="flex flex-row items-center gap-4 pb-2">
					{#each data.project.data[0].stack as stack}
						<div class="flex flex-row items-center gap-4">
							<p
								class="border-solid p-2 rounded-full border-2 text-center"
							>
								{stack}
							</p>
						</div>
			...
			{#if data.project.data[0].Cover}
				<img
					src="{data.directus_api_url}/assets/{data.project.data[0]
						.Cover}/image.png?quality=50&width=1024&height=328"
					alt={data.project.data[0].title}
	...
	<div class="content">
		<div class="max-w-xl w-full">
			<div
				class="prose-override prose post flex flex-col items-left max-w-xl w-full"
			>
